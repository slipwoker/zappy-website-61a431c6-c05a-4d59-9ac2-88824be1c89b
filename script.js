document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, fieldName, extra) {
    ...
    const messages = {
      ...
      minlength: isRTL
        ? 'يجب أن يحتوي هذا الحقل على ' + extra + ' أحرف على الأقل'
        : 'This field must be at least ' + extra + ' characters',
      maxlength: isRTL
        ? 'يجب ألا يتجاوز هذا الحقل ' + extra + ' حرفاً'
        : 'This field must not exceed ' + extra + ' characters'
    };

    return messages[type] || (isRTL ? 'قيمة غير صحيحة' : 'Invalid value');
  }
  ...
  if (staggerContainers.length > 0 && 'IntersectionObserver' in window) {
    ...
    staggerContainers.forEach(function (container) {
      Array.from(container.children).forEach(function (child) {
        child.classList.add('fade-in-ready');
      });
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '61a431c6-c05a-4d59-9ac2-88824be1c89b',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '61a431c6-c05a-4d59-9ac2-88824be1c89b';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 0523166166 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '61a431c6-c05a-4d59-9ac2-88824be1c89b';
